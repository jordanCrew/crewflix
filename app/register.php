...
require_once("includes/classes/Constants.php");
    ...
    if(isset($_POST["submitButton"])){
        ...
        $lasttName = FormSanitiser::santiseFormString($_POST["lastName"]);
        $username = FormSanitiser::santiseFormUsername($_POST["username"]);
        $email = FormSanitiser::santiseFormUsername($_POST["email"]);
        $email2 = FormSanitiser::santiseFormUsername($_POST["email2"]);
        $password = FormSanitiser::santiseFormPassword($_POST["password"]);
        $password2 = FormSanitiser::santiseFormPassword($_POST["password2"]);

        $success = $account->register($firstName, $lasttName, $username, $email, $email2, $password, $password2);
